...
import io from 'socket.io-client'; // Importa io desde socket.io-client
...
//         <div>
//           <h2 className="">Velocidad: {speed}</h2>
//           <h2>Aceleración: {acceleration}</h2>
//         </div>
//         <Gauge
//           value={speed}
//           startAngle={-110}
...
//             },
//           }}
//           text={({ value, valueMax }) => `${value} km/h / ${valueMax}`}
//           style={{ height: '200px' }} // Establecer una altura para el contenedor del gráfico
...
//       <div className="flex justify-center items-center mt-4">
//         <div>
//           <h2 className="">Cantidad de Pedaleos: {cantidadPedaleos}</h2>
//           <h2>Distancia: {distancia} km</h2>
//         </div>
//         <Gauge
//           value={cantidadPedaleos}
